...
import com.components.player.Photodisplay;
 ...
 * @author lenovo
 */
public class picturescreen extends javax.swing.JFrame {
  ...
  private int screen;
    ...
    public static void showOnScreen(int screen, Photodisplay frame) {
        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
        GraphicsDevice[] gs = ge.getScreenDevices();
...
screen1=1;        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(screen1!=0){
            showOnScreen(screen1, new Photodisplay());
           // showOnScreen(screen2, new Photodisplay());
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(picturescreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new picturescreen().setVisible(true);
            }
        });
    }
